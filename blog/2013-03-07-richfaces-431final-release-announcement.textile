...
description: "The final release of RichFaces 4.3.1 is now available.  This micro release addresses some bugs present in the RichFaces 4.3.0.Final release, and offers some improvements on the new features introduced in that same release."
---
