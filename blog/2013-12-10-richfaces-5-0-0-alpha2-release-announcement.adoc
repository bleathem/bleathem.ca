...
[.alert.alert-info]
*To try out this release:* You can download the distribution http://www.jboss.org/richfaces/download/milestones[directly], or for maven users, increment the RichFaces version in your pom.xml to 5.0.0.Alpha2. For more information on setting up a RichFaces application, refer to our http://community.jboss.org/wiki/GettingstartedwithRichFaces4x[getting started guide].
...
Checkout what we have so far by browsing the http://www.richwidgets.io[RichWidgets demo site], of by taking a look at the https://github.com/richwidgets/richwidgets/[source code on GitHub].  If you are still curious, learn more about RichWidgets in the RichWidgets 0.1 release announcement.
